            ...
            <div class="col-lg-9">
                ...
                <div class="car__details__pic">
                   <div class="car__details__pic__large">
                       <img class="car-big-img" src="{{ asset("$detail->main_image") }}" alt="ESR Executive Super Rides Limited">
                    </div>
                   <div class="car-thumbs">
                       <div class="car-thumbs-track car__thumb__slider owl-carousel">
                             @foreach ($detail->vehicleImages as $image)
            ...
            <div class="col-lg-3">
                <div class="car__details__sidebar">
                    <div class="car__details__sidebar__model">
                        <ul>
                            <li>Make <span>{{$detail->makes->name}}</span></li>
                            <li>Model <span>{{$detail->models->name}}</span></li>
                            <li>Year <span>{{ $detail->year }}</span></li>
                            <li>Fuel <span>{{ $detail->fuel }}</span></li>
                            <li>Capacity <span>{{ $detail->capacity }}</span></li>
                            <li>Colour <span>{{ $detail->color }}</span></li>
                            <li>Drivetrain <span>{{ $detail->drive->name }}</span></li>
                            <li>Body Type <span>{{ $detail->body->name }}</span></li>
                            <li>Transmission <span>{{ $detail->transmission->name }}</span></li>
                        </ul>
                        
                    </div>
                    <div class="car__details__sidebar__payment">
                        <a href="{{ url('contact-us') }}" class="primary-btn"><i class="fa fa-credit-card"></i> Intent to buy</a>
